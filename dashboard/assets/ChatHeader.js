          ...
          <div className="space-y-3">
            {historyLoading
              ...
              : [
                  ...
                  <div
                    key={i}
                    className="p-2 hover:bg-blue-50 rounded-xl cursor-pointer group transition-colors"
                  >
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between p-1">
                ...
                >
                  <div
                    className={`absolute top-1 w-3 h-3 bg-white rounded-full shadow-sm transition-all ${ttsEnabled ? "right-1" : "left-1"}`}
                  ></div>
                </button>
              </div>
              ...
              {ttsEnabled && voices.length > 0 && (
                <div className="flex flex-col gap-1.5 p-1 animate-fadeIn">
                  ...
                  <select
                    ...
                    className="w-full bg-gray-50 border border-gray-100 rounded-xl py-2 px-3 text-xs outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-100/30 transition-all appearance-none"
                  >
